      ...
      <div className="container py-16 md:py-20">
        ...
        <div className="mt-14 border-t border-white/10 pt-8">
          <p className="text-xs leading-relaxed text-white/40">
            {siteConfig.brokerage}. Not intended to solicit buyers or sellers currently under
            contract. All measurements and figures on this site are estimates for illustration only
            and do not constitute an appraisal, financial advice, or a guarantee of value. Home
            valuation ranges are generated by an automated model from demo neighbourhood data.
